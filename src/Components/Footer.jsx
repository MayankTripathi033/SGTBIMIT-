  ...
  return (
    <footer>
        <div className="footer-grid">
          ...
          <img src={require('../images/socials/pinterest.png')} alt="cant load"  onClick={(e)=>{window.location.href = "https://twitter.com/nssipu_sgtbimit"}}></img>
          ...
          <img src={require('../images/socials/youtube.png')} alt="cant load"  onClick={(e)=>{window.location.href = "https://twitter.com/nssipu_sgtbimit"}}></img>
        </div>
